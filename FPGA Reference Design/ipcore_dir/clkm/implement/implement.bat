...
xst -ifn xst.scr
move clkm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkm_exdes.ucf clkm_exdes

echo 'Running map'
map -timing -pr b clkm_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clkm_exdes -w routed.ncd routed.vhd
cd ..
